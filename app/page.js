  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Disfruta experiencias náuticas únicas en Formosa, Argentina. Canotaje, travesías y más con Nautica Ajere Ysyripe."
        />
        <meta
          name="keywords"
          content="nautica, Formosa, canotaje, travesías, experiencias náuticas, Argentina"
        />
        <meta name="author" content="Nautica Ajere Ysyripe" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta
          property="og:title"
          content="Nautica Formosa - Canotaje y Travesías"
        />
        <meta
          property="og:description"
          content="Vive aventuras únicas en Formosa, Argentina. Canotaje y travesías inolvidables."
        />
      ...
      <div className={styles.container}>
        ...
        <h1 className={styles.title}>
          Nautica Ajere Ysyrype - Canotaje en Formosa, Argentina
        </h1>
        <h2 className={styles.description}>
          Experiencias náuticas, ¿te sumás?
        </h2>
        <TresBotones />
        <Carrusel />
        {/* <WeatherWidget /> */}
